...
public class ControlClient {
    ...
    public Client controlClientRegister() throws SQLException{
        Client client = viewClient.clientData();
        client = serviceClient.serviceSaveClient(client);
        //client = serviceClient.clientLogged(client);
        return client;
    }

    public Client controlClientLogged() throws SQLException {
...
//        while (true) {
//            List<Client> clients = clientDAO.selectClies();
//            System.out.println("""
//                    1. Cadastrar cliente
